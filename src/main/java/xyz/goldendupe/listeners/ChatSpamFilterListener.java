...
public class ChatSpamFilterListener implements GDListener {
    private final Map<UUID, Integer> messages = new HashMap<>();
    private final Pattern pattern = Pattern.compile("((?i)\\[item]|\\[i])");
    private final GoldenDupe goldenDupe;

    public ChatSpamFilterListener(GoldenDupe goldenDupe) {
