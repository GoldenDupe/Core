...
public class StrengthAction extends Action {
    protected StrengthAction(ActionManager actionManager) {
        super(actionManager, PerkTranslations.PERK_KILL_STRENGTH_TITLE,
                PerkTranslations.PERK_KILL_STRENGTH_DESCRIPTION,
                PerkTranslations.PERK_KILL_STRENGTH_UPGRADABLE_DESCRIPTION,
                PerkTranslations.PERK_KILL_STRENGTH_MAX_DESCRIPTION,
